\section{Introduction to Privacy Standards}
...
\begin{itemize}
    \item \textbf{ISO/IEC 29100 Privacy framework}: it provides a privacy framework which specifies a common privacy terminology, defines the actors and their roles in processing personally identifiable information (PII) and describes privacy safeguarding considerations;
    \item \textbf{ISO/IEC 29151 Code of practice for personally identifiable information protection}: it establishes control objectives, controls and guidelines for implementing controls, to meet the requirements identified by a risk and impact assessment related to the protection of PII;
