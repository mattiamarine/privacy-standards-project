...
and the existing or planned controls. To better understand how to estimate the level of impact
and the likelihood
...
how much damage can be caused by all the potential impacts. By answering this question, one can
...
\input{tables/level_of_impact.tex}
...
The answer one should seek is to what degree e can the properties of supporting assets be exploited in order to carry out a threat.
