...
The assessor, on his side, should define the \textbf{risk criteria} and the crieria for 
...
This section provides guidance on the contect of the \textbf{PIA report}.
...
The answer one should seek is \textbf{what degree e can the properties of supporting assets be exploited in order to carry out a threat}.
