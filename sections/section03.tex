\section{ISO/IEC 29151: Code of Practice for PII Protection}

\begin{figure}[H] 
    \centering
    \includegraphics[width=0.5\textwidth]{images/iso_29151.png} % percorso e scala
    \caption{ISO/IEC 29151:2022}
    \label{fig:iso29151}
\end{figure}

%section
\subsection{Overview of the standard and Purpose}
\textbf{ISO/IEC 29151} is a globally recognised standard that provides \textbf{guidelines for protecting personally identifiable information (PII)} in information technology.
The primary focus of ISO/IEC 29151 is to establish controls and guidelines that organisations can implement to manage privacy risks related to the processing of PII.

\vspace{\baselineskip}
ISO/IEC 29151 is a crucial component of data privacy as it provides a comprehensive framework for the protection of personal data. It is particularly relevant today, as the collection, processing and storage of personal data have become more and more frequent. 
This standard is designed to \textbf{help organisations manage the privacy of personal data} in a systematic and consistent manner, thereby reducing the risk of data breaches and ensuring compliance with data protection regulations.

\vspace{\baselineskip}
The standard applies to \textbf{all types and sizes of organisations}, including public and private companies, government entities and not-for-profit organisations. It is also applicable to all sectors and industries that process PII, such as healthcare, finance, education and retail. 
...
\vspace{\baselineskip}
While implementing ISO/IEC 29151 can provide several benefits, it can also pose some \textbf{challenges}. One of the main challenges is the \textbf{complexity of the standard}, which requires a deep understanding of privacy principles and controls. Implementing the standard can also require significant time and resources, particularly for organisations that do not have a pre-existing privacy management system.

Another challenge in implementing ISO/IEC 29151 is the \textbf{need for cultural change}. Protecting PII requires the involvement and commitment of all employees, which can be difficult to achieve in organisations with a low awareness of privacy issues. Furthermore, the standard requires \textbf{ongoing monitoring and review}, which can be challenging to maintain over time. \cite{privacyengine_iso_29151_2025}

It was published on September 28, 2017 and adopted in Europe as EN ISO/IEC 29151 in 2022.


%section
\subsection{Requirements for the Protection of PII}
An organization should identify its PII protection requirements and the privacy principles in ISO/IEC 29100 can help for the identification of requirements.

There are three main \textbf{sources of PII protection requirements}:
\begin{itemize}
    ...
    \item corporate policies, means that an organization may also choose voluntarily to go beyond the criteria that are derived from previous requirements.
\end{itemize}

PII protection controls should be selected on the basis of a \textbf{risk assessment}. The results of a 
\textbf{Privacy Impact Assessment (PIA)} (later analysed in ISO/IEC 29134) will help to guide and determine the appropriate 
...
This standard is structured into several sections, each of which covers a specific aspect of privacy controls. The main sections of the standard include the scope, normative references, terms and definitions, privacy principles and controls.

The standard also includes several \textbf{annexes} that provide additional guidance and examples of privacy controls and cover topics such as the relationship between ISO/IEC 29151 and other standards, the implementation of privacy controls and the management of privacy risks.


\vspace{\baselineskip}
The \textbf{privacy controls} presented in this standard can be used as reference for organizations that process PII, and the selection of controls is dependent upon organizational decisions based on the criteria for risk treatment options. 
...
\vspace{\baselineskip}
The following sections of this report provide a detailed analysis of privacy controls and guidelines defined in \textbf{ISO/IEC 29151}, by following and amplifying controls defined in \textbf{ISO/IEC 27002}.
...
\vspace{\baselineskip}
Each section contains the \textbf{objective} of the most relevant controls, the \textbf{implementation guidance} provided in ISO/IEC 27002 and the \textbf{implementation guidance for the protection of PII} provided in ISO/IEC 29151.
This last part is present in ISO/IEC 29151 for every control analysed.
...
\cite{iso_29151_2017} \cite{iso_27002_2022} The objective of this control is:

\vspace{\baselineskip}
"\textit{to provide management direction and support for information security in accordance with 
business requirements and relevant laws and regulations.}"

\vspace{\baselineskip}
Organizations should define an \textbf{information security policy} which sets out the organisation's approach to managing its information security objectives.

At lower level, the information security policy should be supported by policies related to specific topics, such as access control, physical and environmental security, backup, cryptography and so on.
...
All these policies will be analysed in the following sections of this report.

\vspace{\baselineskip}
For this specific control, ISO/IEC 29151 suggests that the information security policy should include specific aspects related to PII protection. 
These aspects are described in the \textbf{Annex 2} of the standard and include some \textbf{guidance already mentioned in ISO 29100}, such as:
\begin{itemize}
    \item the \textbf{PII protection policy} should be appropriate to the purpose of the organization;
    \item it should define rules for making decisions for protection of PII;
...
\cite{iso_29151_2017} \cite{iso_27002_2022} The objective in this case is the following:
...
This control is divided into \textbf{several sub-controls} that cover different aspects of the internal organizations. The following sub-sections are the most relevant ones:

\subsubsection*{Information security roles and responsabilities}
...
\vspace{\baselineskip}
Regarding \textbf{PII protection}, it is important to define specific roles for the protection of PII, such as an individual or a group of them that should have the responsability for guarantee the coordination between information security functions and PII protection functions.
...
\vspace{\baselineskip}
With respect to \textbf{PII protection}, a fondamental aspect to consider is that duties related to PII protection should be independent of those for information security. 
As a consequence, the principle of segregation of duties should be considered when dealing with access rights for PII processing, especially when the risk involved in processing PII is high.

\subsubsection*{Contact with authorities}
...
\vspace{\baselineskip}
Regarding \textbf{PII protection}, organizations should have procedures that specify when and by whom authorities, such as Data Protection Authorities, should be contacted to report privacy breaches or to report processing details.
...
\vspace{\baselineskip}
"\textit{to ensure that employees and contractors understand their responsibilities and are suitable for the roles for which they are considered, and to  ensure that employees and contractors are aware of and fulfil their information security responsibilities.}"

\vspace{\baselineskip}

This section of the standard contains many sub-controls related to Human Resource Security, that are fundamental for the protection of PII.
In particular, in this report there is a focus only on the controls that ISO/IEC 29151 amplifies with specific implementation guidance for the protection of PII.

One of them is \textbf{Human resource security during employment}. 
...
\begin{itemize}
    ...
    \item achieve a level of awerness relevant to their roles and responsibilities;
    \item have the necessary skills and continue to develop them.
\end{itemize}

If they do not respect these aspects, they could represent a \textbf{risk} for the organization and for the protection of PII.
With respect to PII, one fundamental aspect introduced by ISO/IEC 29151 is the need to provide \textbf{specific training} for the possible consequences for the PII controller
...
\cite{iso_29151_2017} \cite{iso_27002_2022} In this case, the two main sub-controls analysed with respect to Asset Management are the \textbf{Responsability for Assets} and \textbf{Information Classification}.
...
Regarding \textbf{guidance for PII protection}, ISO/IEC 29151 suggests that this invetory of assets should be established and maintained following the information reported in the PIA report.
Starting from that, the organisation should extract some relevant informations, such as the types of PII processed, the level of impact of any breach of PII, the purposes of collecting the PII and the retention period of PII.

\vspace{\baselineskip}
With respect to \textbf{Information Classification}, it is suggested to classify general information according to legal requirements, criticality and sensitivity to unauthorised disclosure or modification.
The \textbf{classification scheme} should be consistent across the whole organization so that everyone will classify information 
...
For \textbf{PII protection}, ISO/IEC 29151 shows that the classification scheme should consider also all information containing PII.
...
\cite{iso_29151_2017} \cite{iso_27002_2022}This control is focused on:

\vspace{\baselineskip}
"\textit{ensure authorized user access and prevent unauthorized access to systems and services.}"

\vspace{\baselineskip}
This means that procedures for \textbf{user registration and de-registration} should be implemented and an organization should provide also measures to manage a \textbf{compromise of user access control}, such as 
the corruption of passwords or other user registration data.

It is also important that organizations provide users with an \textbf{appropriate right of access} to the information systems processing PII, in 
accordance with the data minimization principle described in ISO/IEC 29100. 
It is necessary to limit access to information systems processing PII to only those users who really need that access. As a consequence, \textbf{strong authentication methods} should be applied for particular PII and PII processing.

ISO/IEC 29151 focuses its attention also on the fact that large scale processing of PII can increase the risk of \textbf{large scale breaches}.
Therefore, it is necessary to take special care when dealing with access rights for these privileged operations.
The granting and use of such rights should be recorded in relevant log files and regularly reviewed.


%section
\subsection{Cryptography}
\cite{iso_29151_2017} \cite{iso_27002_2022} The objective in this case is:
...
\vspace{\baselineskip}
For this section of the standard, no specific implementation guidance for the protection of PII is provided. 
It is considered that the general guidance provided in ISO/IEC 27002 are sufficient to address the protection of PII as well.

\vspace{\baselineskip}
The following are some \textbf{relevant aspects regarding Cryptography} that are mentioned in ISO/IEC 27002 and automatically apply to PII protection.
When developing a \textbf{cryptographic policy}, the most important aspects to consider are the following:
\begin{itemize}
   \item based on a risk assessment, the \textbf{required level of protection} should be identified taking into account the type, strength and quality of the encryption algorithm required;
   \item who is \textbf{responsible for implementing the policy} and for managing the cryptographic keys;
   \item the \textbf{standards to be adopted} for effective implementation throughout the organization;
   \item the \textbf{regulations and national restrictions} that might apply to the use of cryptographic techniques in different parts of the world;
   \item \textbf{requirements for key management}, such as key generation, distribution, storage, use, destruction and archiving;
   \item \textbf{protection of cryptographic keys} against modification, loss or destruction and against unauthorised access.
\end{itemize}
...
\vspace{\baselineskip}
This section of the standard contains many sub-controls related to Physical and Environmental Security, such as supporting utilities, cabling security, equipment maintenance, secure disposal or re-use of equipement and so on.
They express some important concepts that have important roles in the Environmental Security.

The following are the most relevant ones with respect to the \textbf{Secure Areas} sub-control:
\begin{itemize}
    \item \textbf{Physical Security Perimeter}: define perimeters to protect areas that contain sensitive and PII information;
...
\vspace{\baselineskip}
With respect to the \textbf{Equipment} sub-control, the most relevant aspects are the following:
\begin{itemize}
...
It specifies that equipment containing storage media that may possible contain PII should be destroyed or the PII should either be destroyed, deleted or overwritten using approved techniques,
...
\cite{iso_29151_2017} \cite{iso_27002_2022} Objectives:

\vspace{\baselineskip}
"\textit{ensure correct and secure operation of information processing facilities;
protect against loss of data;
record events and generate evidence.}"

\vspace{\baselineskip}
Also for this section of the standard, there are different sub-controls analysed.
...
\subsubsection*{Operational Procedures and Responsabilities}
...
\cite{iso_29151_2017} \cite{iso_27002_2022} The objective is:
...
With respect to \textbf{PII protection}, ISO/IEC 29151 suggests to apply some appropriate measures to reduce the risk of PII leakage during information transfer.
...
\cite{iso_29151_2017} \cite{iso_27002_2022} This control contains two main sub-controls that ISO/IEC 29151 amplifies: \textbf{Security Requirements of Information Systems} and \textbf{Test Data}.
...
\subsubsection*{Security Requirements of Information Systems}
...
For \textbf{PII protection}, ISO/IEC 29151 suggests that when developing or making significant changes to information systems that process PII, a PIA should be conducted. 
The results of the PIA should be used to determine the 
controls to treat the risks identified during the PIA process.
Guidance for conducting PIAs is provided in \textbf{ISO/IEC 29134}, in the next chapter of this report.
...
\cite{iso_29151_2017} \cite{iso_27002_2022}Supplier Relationships control focus on the following objective:

\vspace{\baselineskip}
"\textit{ensure protection of the organization's assets that is accessible by suppliers.}"
...
on the basis of \textbf{experience}, \textbf{trustworthiness} and their ability to meet \textbf{PII protection} requirements.
...
\cite{iso_29151_2017} \cite{iso_27002_2022} The main control for this section is \textbf{Management of Information Security Incident and Improvements} and it is focused on:
...
\subsubsection*{Responsabilities and Procedures}
...
Organizations should be capable of providing an effective response to a privacy incident and implement a \textbf{privacy incident response plan}.
The privacy plan should include:
\begin{itemize}
    \item the \textbf{definition of privacy incident} and the scope of privacy incident response;
    \item the establishment of a \textbf{cross-functional privacy incident response team} that develops, implements, tests, executes and reviews the privacy incident response plan;
    \item clearly defined \textbf{roles, responsibilities and authorities} for all members of the privacy incident response team; 
    \item an \textbf{incident impact assessment} to determine the nature of any potential or actual harms to affected individuals;
    \item procedures to determine whether \textbf{notice to affected individuals} and other designated entities is required, the \textbf{timing} for such notice and the \textbf{form} used to provide that notice.
\end{itemize}
...
\subsubsection*{Reporting Information Security Events}
...
\cite{iso_29151_2017} \cite{iso_27002_2022} For this control, there are two main sub-controls amplified by ISO/IEC 29151:
\begin{itemize}
    \item \textbf{Compliance with Legal and Contractual Requirements};
    \item \textbf{Information Security Reviews}.
\end{itemize}
...
Organizations should identify the \textbf{laws and regulations related to PII protection} to which they are subject. If these are 
identified, then organizations should take necessary measures for those requirements.

Organizations should develop PIAs and implement the resulting \textbf{privacy treatment plans} in order to help ensure that 
...
They should also establish an \textbf{audit program} to help verify that PII processing complies with relevant privacy 
safeguarding requirements. The program should specify the frequency with which audits are to be conducted.

\vspace{\baselineskip}
While in many jurisdictions it will be the PII controller who is ultimately responsible for ensuring compliance, \textbf{all actors 
...
\subsubsection*{Information Security Reviews}
The objective is:
...
\vspace{\baselineskip}
The organization’s approach to managing information security and its implementation should be \textbf{reviewed independently at planned intervals} or \textbf{when significant changes occur.}
...
This chapter provide an analysis of the structure of \textbf{ISO/IEC 29151} and a detailed description of the main controls defined in the standard.
While ISO/IEC 29100 defines the overall privacy principles and framework, ISO/IEC 29151 translates those principles into concrete operational measures and guidance that organizations can implement to protect PII.

Its alignment with ISO/IEC 27002 ensures interoperability between information security and privacy management.
This standard can be considered as a practical guide for organizations aiming to enhance their PII protection practices and comply with relevant privacy regulations.