...
trust. ISO/IEC 29100 provides an overview of the different factors that can influence the selection and implementation of privacy safeguarding requirements 
...
They can be very general, such as the high-level privacy principles an organization is expected to take into account when processing PII. Or, they can be very specific, or mandate the implementation of specific privacy controls.
...
\begin{itemize}
    \item legal and regulatory factors for the safeguarding of the natural person's privacy and the protection of their PII;
    \item contractual factors such as agreements between and among several different actors, company policies and binding corporate rules;
    \item business factors predetermined by a specific business application or in a specific use case context;
    \item other factors that can affect the design of ICT systems and the associated privacy safeguarding requirements.
\end{itemize}
...
relates to the privacy preferences of PII principals. The personal disposition of a natural person towards 
...
ISO/IEC 29100 provides a comprehensive framework for the protection of personally identifiable information (PII) within ICT systems.
...
This framework is essential for organizations seeking to develope operational privacy controls and policies, supporting 
